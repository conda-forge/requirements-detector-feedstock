...
validate_recipe_outputs "requirements-detector-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="requirements-detector-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi